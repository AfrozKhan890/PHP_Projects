...
-- INSERT INTO `barber_admin` (`admin_id`,`role`, `username`, `email`, `full_name`, `password`) VALUES
-- (1, 'admin','admin', 'admin.admin@gmail.com', 'Admin Admin', 'f7c3bc1d808e04732adf679965ccc34ca7ae3441');
INSERT INTO `barber_admin` (`admin_id`, `username`, `email`, `full_name`, `password`, `role`) 
VALUES (NULL, 'admin', 'admin.admin@gmail.com', 'Admin Admin', 'd033e22ae348aeb5660fc2140aec35850c4da997', 'admin')
-- --------------------------------------------------------
