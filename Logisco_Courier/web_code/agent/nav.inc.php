...
if (!isset($_SESSION['AGENT_ROLE']) || $_SESSION['AGENT_ROLE'] !== true) {
...
<head>
    <title>Logisco Agent Panel</title>
    <meta charset="utf-8">
                            ...
                            <div class="header-grid">
                                    ...
                                    <div class="dropdown">
                                        <button class="btn btn-secondary dropdown-toggle" type="button"
                                            ...
                                            <span class="header-item">
                                                ...
                                                <span class="text-tiny"><?php echo $_SESSION['notification_count']?></span>
                                                <?php }?>
                                                <i class="icon-bell"></i>
                                            </span>
                                        </button>
                                ...
                                <li>
                                    <div class="message-item item-2">
                                        ...
                                        <div>
                                            <div class="body-title-2"><?php echo $_SESSION['contact']['name']; ?></div>
                                            <div class="text-tiny"><?php echo $_SESSION['contact']['message']; ?></div>
                                        </div>
                                    </div>
                                </li>
